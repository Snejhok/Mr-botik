...
word_list = ['3bu1a','Ебула','Снежок','Кендоку рамен','Солнце','Птица','Подпивас','Аболтус','Пидор','Тварь дрожащая','Анекдот',
             'Учитель','Сигарета','Чапман','Клоун','Траншея','Павлодар','Казахстан','Тяги','Найк','Адидас','Приора','Ворона',
             'Кошка','Собака','Еблан','Человек','Подсолнух','Аутист','Снегридзе','Мистер Ботик',
]
@bot.command()
